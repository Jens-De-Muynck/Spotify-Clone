<?php
    ...
    // query uitvoeren alle bewaarde songs om in centrum pagina te plaatsen
            ...
            <section class="row" id="content">
                <header class="col-12">
                    <div class="row">
                        ...
                        <div class="col-6 text-right" id="content-followers">X aantal followers</div>
                    </div>
                </header>
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    while($row = $resLijstSongs->fetch_assoc()){
                                        ...
                                        // De check wist een liedje van saved songs
